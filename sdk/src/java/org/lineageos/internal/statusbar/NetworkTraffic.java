...
public class NetworkTraffic extends TextView {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_TYPE_ADD_NETWORK:
                    ...
                    Pair<Network, LinkProperties> lph = (Pair<Network, LinkProperties>) msg.obj;
                    traffic.mLinkPropertiesMap.put(lph.first, lph.second);
    ...
    private void recalculateStats() {
        ...
        // hw offload tether stats (STATS_PER_IFACE, UID_ALL)
        try {
            NetworkStats tetherStats = mNetworkManagementService.getNetworkStatsTethering(
                    NetworkStats.STATS_PER_IFACE);
            if (tetherStats != null) {
                NetworkStats.Entry entry = null;
                for (int i = 0; i < tetherStats.size(); i++) {
                    entry = tetherStats.getValues(i, entry);
    ...
    private void updateSettings() {
        ...
        if (mMode != MODE_DISABLED && mDrawable != null) {
            mDrawable.setColorFilter(mIconTint, PorterDuff.Mode.MULTIPLY);
        }
        updateViewState();
    }
    ...
    private final ConnectivityManager.NetworkCallback mNetworkCallback =
        ...
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            ...
            msg.obj = new Pair<>(network, linkProperties);
